...
console.log("Queremos saber el alumnos que tiene 30 años de edad");
const edad30= alumnos.find(alumno=>alumno.edad===30);
console.log("Nos retorna el alumno con edad 30 ");
console.log(edad30);
console.log("2. some");
...
console.log("Nos retorna un arreglo de tipo boolean en el caso encuentre un elementos con la condicion el bolean sera true, caso contrario false.")
...
console.log("Para este ejemplo nos permite validad si todos los elementos del arrreglo edades son mayores de 18 años., Retorna un true o false");
...
console.log("A diferencia de forach el map si lo almacena el resultado del recorrido en otro arreglo.")
...
console.log("En esta caso devuelve un nuevo arreglo filtrando los numeros mayores a  25");
...
console.log("Se desea sumar todos los numeros del arreglo");
